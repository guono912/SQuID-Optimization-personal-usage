...
# DESC imports JAX at module import time. Keep direct CLI imports deterministic
# on machines without a configured accelerator, while respecting an explicit
# caller choice of backend.
os.environ.setdefault("JAX_PLATFORMS", "cpu")

# Make the grouped script executable directly from a source checkout, matching
# the documented ``python scripts/util/...`` invocation.
import sys
...
from squid.evaluation.coil_metrics import curve_metrics_xyz, make_winding_surface
