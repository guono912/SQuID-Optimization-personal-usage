...
Reusable CLI implementation: scripts/seed/generate_seed.py and the legacy
scripts/generate_seed.py wrapper both call into this module.
...
def _from_analytic(args):
    ...
    from ..utils.generate_initial import write_vmec_input
