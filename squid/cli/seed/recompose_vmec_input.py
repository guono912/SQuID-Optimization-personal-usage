#!/usr/bin/env python3
"""Recompose a VMEC input boundary with low-mode filtering (reusable CLI).

scripts/seed/recompose_vmec_input.py and the legacy
scripts/recompose_vmec_input.py wrapper both call into this module.
"""
